...
import { Video, Phone, MessageCircle, Send, HelpCircle } from "lucide-react";
...
export default function PatientVideo() {
  ...
  const sendMessageMutation = useMutation({
    mutationFn: async ({ content, isUrgent }: { content: string; isUrgent: boolean }) => {
  ...
  const handleSendMessage = (isUrgent: boolean = false) => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white min-h-screen pb-16">
      <div className="p-4">
        <h1 className="text-xl font-bold text-sage-800 mb-4">Comunicazione con il Medico</h1>
        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-3">
            ...
            <Button
              ...
              className="bg-sage-500 hover:bg-sage-600 self-end"
            >
